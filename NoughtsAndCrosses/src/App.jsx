...
function deriveWinner(gameBoard, players) {
  ...
  let firstSquareSymbolInGameBoard = gameBoard[combination[0].row][combination[0].column]
  let SecondSquareSymbolInGameBoard = gameBoard[combination[1].row][combination[1].column]
  let ThirdSquareSymbolInGameBoard = gameBoard[combination[2].row][combination[2].column]

  if(firstSquareSymbolInGameBoard && firstSquareSymbolInGameBoard === SecondSquareSymbolInGameBoard && firstSquareSymbolInGameBoard === ThirdSquareSymbolInGameBoard) {
    winner = players[firstSquareSymbolInGameBoard]
  }
}
    ...
    <main>
      <div id="game-container">
        <ol id="players" className="highlight-player">
          <Player initialName={initialplayers.X} symbol="X" isActive={activePlayer === "X"} onChangeName={handlePlayerNameChange}></Player>
          <Player initialName={initialplayers.O} symbol="O" isActive={activePlayer === "O"} onChangeName={handlePlayerNameChange}></Player>
        </ol>
